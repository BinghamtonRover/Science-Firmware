...
#define ScienceCommand_init_default              {0, 0, 0, _PumpState_MIN, _ServoState_MIN, _ServoState_MIN, _CarouselCommand_MIN, 0, 0, 0, _ScienceState_MIN, 0}
#define ScienceData_init_default                 {0, _ScienceState_MIN, 0, 0, 0}
#define ScienceCommand_init_zero                 {0, 0, 0, _PumpState_MIN, _ServoState_MIN, _ServoState_MIN, _CarouselCommand_MIN, 0, 0, 0, _ScienceState_MIN, 0}
...
#define ScienceCommand_carousel_subsurface_tag   12
...
X(a, STATIC,   SINGULAR, FLOAT,    carousel_subsurface,  12)
