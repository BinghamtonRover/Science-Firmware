...
typedef struct _ScienceCommand {
    ...
    ScienceState state;
    /* Scooper */
    float scooper_rotate;
    int32_t scooper_pinch;
    bool set_scooper_pinch;
} ScienceCommand;
...
#define ScienceCommand_init_default              {0, 0, 0, 0, _PumpState_MIN, _DirtReleaseState_MIN, _PumpState_MIN, _PumpState_MIN, _PumpState_MIN, _PumpState_MIN, 0, 0, 0, 0, 0, _ScienceState_MIN, 0, 0, 0}
#define ScienceData_init_default                 {0, 0, 0, 0, 0, 0, _ScienceState_MIN, 0}
#define ScienceCommand_init_zero                 {0, 0, 0, 0, _PumpState_MIN, _DirtReleaseState_MIN, _PumpState_MIN, _PumpState_MIN, _PumpState_MIN, _PumpState_MIN, 0, 0, 0, 0, 0, _ScienceState_MIN, 0, 0, 0}
#define ScienceData_init_zero                    {0, 0, 0, 0, 0, 0, _ScienceState_MIN, 0}
...
#define ScienceCommand_scooper_rotate_tag        18
#define ScienceCommand_scooper_pinch_tag         19
#define ScienceCommand_set_scooper_pinch_tag     20
...
#define ScienceData_distance_to_ground_tag       8
...
X(a, STATIC,   SINGULAR, FLOAT,    scooper_rotate,   18) \
X(a, STATIC,   SINGULAR, INT32,    scooper_pinch,    19) \
X(a, STATIC,   SINGULAR, BOOL,     set_scooper_pinch,  20)
...
X(a, STATIC,   SINGULAR, FLOAT,    distance_to_ground,   8)
...
#define ScienceCommand_size                      76
#define ScienceData_size                         43
